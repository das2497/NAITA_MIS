                                    ...
                                    <div id="unimBody" class="table-responsive">
                                        <table class="table table-striped shadow">
                                            ...
                                            <tbody>
                                                ...
                                                $rows = 4;
                                                $ofset = 1 + ($pg - 1) * $rows;
                                                $urs = Database::search("SELECT * FROM university INNER JOIN uni_type ON university.uni_type_uni_typ_id=uni_type.uni_typ_id LIMIT $rows OFFSET " . ($ofset - 1) . ";");
                                                $un = $urs->num_rows;
                                                $urs2 = Database::search("SELECT * FROM university INNER JOIN uni_type ON university.uni_type_uni_typ_id=uni_type.uni_typ_id;");
                                                $un2 = $urs2->num_rows;
                                                $pgs = Pagination::pg($rows, $un2, 'test3.php');
                                                while ($ursr = $urs->fetch_assoc()) {
                                                ?>
