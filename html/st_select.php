...
<div class="row" onload="searchindist('<?= $_POST['deg']; ?>','<?= $_POST['uni']; ?>','<?= $_POST['yr']; ?>','<?= $_POST['field']; ?>');">
    ...
    <div class="col-10 offset-1 col-lg-8 offset-lg-2 w-75 input-group my-3">
        <span class="input-group-text bg-transparent " id="inputGroup-sizing-default">Search</span>
        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" id="sbar" onkeyup="searchindist('<?= $_POST['deg']; ?>','<?= $_POST['uni']; ?>','<?= $_POST['yr']; ?>','<?= $_POST['field']; ?>');">
    </div>
